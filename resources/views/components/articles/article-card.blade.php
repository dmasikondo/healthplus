@props(['article'])
<article
    {{$attributes->merge(['class'=>'transition-colors duration-300 hover:bg-gradient-to-br hover:from-yellow-50 hover:via-white hover:to-green-50  border border-black border-opacity-0 hover:border-opacity-5 rounded-xl'])}}>
    <div class="py-6 px-5">
